...
public class pro {
	...
	;
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//p[text()='RKK Travels'][1]"));
			driver.findElement(By.xpath("//span[text()='595'][1]")).click();
			driver.findElement(By.xpath("//span[@class='listingSprite femaleBigSeatIcon appendBottom4'][1]")).click();
			Thread.sleep(1000);
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath("//div[@class='femaleTab activeTab']")).click();
			//female.click();
			...
			driver.findElement(By.xpath("//input[@name='email id']")).sendKeys("reshmareama@gmail.com");
